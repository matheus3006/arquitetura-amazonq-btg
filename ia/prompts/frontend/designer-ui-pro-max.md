...
> `ia/design-system/tokens.css` é **convenção da casa adaptável**; a convenção de diagramas
...
> Use `ia/prompts/frontend/designer-ui-pro-max.md`. Mostre 3 direções visuais para documentação interna de microserviços .NET. Audiência: devs sênior + SRE.
