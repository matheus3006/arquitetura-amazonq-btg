...
>
> **A paleta navy/azul atual de `ia/design-system/tokens.css` é convenção da casa**, não regra
...
- **Coerência > criatividade.** Se já há padrão estabelecido (em `ia/design-system/`), siga. Variar arbitrariamente é dívida visual.
...
> Use `ia/prompts/frontend/designer-ux-controlado.md`. Quero definir o visual da documentação de arquitetura do serviço Pagamentos. Stack: HTML + CSS vanilla.
...
## Referências
- Tokens já definidos: `ia/design-system/tokens.css` — use como ponto de partida.
- Componentes existentes: `ia/design-system/components.css`.
