...
> `ia/design-system/components.css` atual. Use este prompt para auditar onde falta ou estender
> a polimentos novos.
>
...
> Use `ia/prompts/frontend/polidor-ui.md`. O componente `.adr-card` está funcional mas duro. Adicione polimento: hover sutil, focus visível premium, entrada com fade quando renderizado dinamicamente.
...
- Componentes a polir: `ia/design-system/components.css`.
- Tokens necessários: `--ease-*`, `--dur-*` em `ia/design-system/tokens.css`.
