...
>
> **Conteúdo das páginas em `ia/templates/`** é **EXEMPLO**. As ADRs reais que você gerar devem
...
> Quero registrar a decisão de usarmos PostgreSQL com row-level locking em vez de Redis como source of truth de saldo. Siga `ia/prompts/arquitetura/gerador-adr.md`. Contexto: incidente IN-2026-042 mostrou inconsistência por TTL do Redis.
...
- Página de exemplo bem estruturada (para referência de FORMA, não de conteúdo): `ia/templates/01-visao-geral.html`.
- Prompt complementar para revisão pós-criação: `ia/prompts/arquitetura/grill-doc.md`.
