...
| `doc/adr/` se existir | ADRs já registradas — não inventar conflitantes |
...
> - 2 ADRs já registradas em `doc/adr/`
>
...
- **Gerado em**: YYYY-MM-DD por `ia/prompts/arquitetura/analisador-de-projeto.md`
...
> Estou no repositório `notificacoes-push-api`. Antes de qualquer doc, siga `ia/prompts/arquitetura/analisador-de-projeto.md` para entender o que é esse projeto.
