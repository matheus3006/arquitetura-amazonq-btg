...
>
> **Conteúdo das páginas em `ia/templates/`** (serviço fictício "Liquidação Transacional", etc.)
...
> Aplique `ia/prompts/arquitetura/grill-doc.md` em `docs/pagamentos/architecture.html` e `docs/pagamentos/adr/0001-outbox.html`, no repo `pagamentos-api`. Cruze com o código real e me dê o relatório.
