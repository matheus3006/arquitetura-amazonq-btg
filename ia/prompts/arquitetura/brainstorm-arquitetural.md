...
>
> **Conteúdo das páginas em `ia/templates/`** é EXEMPLO; aplique este prompt ao serviço REAL.
...
> "Pronto para virar ADR? Posso iniciar usando `ia/prompts/arquitetura/gerador-adr.md`.
> Se a decisão gera trabalho de implementação, o passo seguinte é
> `ia/prompts/engenharia/planejador-de-implementacao.md`."
...
> Estou pensando em substituir o RabbitMQ por Kafka no serviço de Pagamentos. Use `ia/prompts/arquitetura/brainstorm-arquitetural.md` antes de qualquer recomendação.
...
- Decisão aprovada que vira código: `ia/prompts/engenharia/planejador-de-implementacao.md`.
