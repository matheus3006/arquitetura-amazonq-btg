...
## Pré-requisito
`project-context.md` (trilha técnica) idealmente já existe — você o consome aqui. Se faltar, sugira rodar `ia/prompts/arquitetura/analisador-de-projeto.md` antes; mas dá pra seguir a partir do código.
...
## Metadados
- **Gerado em**: YYYY-MM-DD por `ia/prompts/negocio/analisador-de-dominio.md`
- **Versão**: 1.0
...
> Estou no `pagamentos-api`. Siga `ia/prompts/negocio/analisador-de-dominio.md` pra montar a visão de negócio antes de qualquer doc — detecta do código, me grila o que faltar, e grava o `business-context.md`.
