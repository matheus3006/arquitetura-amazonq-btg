...
> Com `business-context.md` pronto no `pagamentos-api`, use `ia/prompts/negocio/catalogo-de-regras.md` pra gerar a página de regras de negócio, agrupada por capacidade.
...
- Lacunas: `ia/prompts/negocio/grill-negocio.md`.
