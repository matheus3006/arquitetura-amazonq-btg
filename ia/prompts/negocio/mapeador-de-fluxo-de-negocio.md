...
>
> Conteúdo de `ia/templates/` é EXEMPLO. Use atores, estados e regras do domínio REAL.
...
> Estou no `pagamentos-api`, com `business-context.md` pronto. Use `ia/prompts/negocio/mapeador-de-fluxo-de-negocio.md` pra documentar o processo de estorno — caminho feliz e as recusas.
...
- Regra/dono faltando: `ia/prompts/negocio/grill-negocio.md`; regras viram página em `catalogo-de-regras.md`.
