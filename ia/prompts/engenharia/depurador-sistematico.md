...
> descrito em `ia/prompts/engenharia/depurador-sistematico.md` — quero a causa raiz demonstrada
...
- Fix cresceu além do pontual? `ia/prompts/engenharia/planejador-de-implementacao.md`.
