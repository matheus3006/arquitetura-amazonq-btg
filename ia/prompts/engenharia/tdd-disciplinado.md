...
> `ia/prompts/engenharia/tdd-disciplinado.md`: teste falhando primeiro, código mínimo,
...
- Causa raiz antes do fix: `ia/prompts/engenharia/depurador-sistematico.md`.
- Onde o ciclo se encaixa no plano: `ia/prompts/engenharia/executor-de-plano.md`.
