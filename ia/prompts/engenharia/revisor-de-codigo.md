...
> `ia/prompts/engenharia/revisor-de-codigo.md` — quero os achados por severidade com
...
## Referências
- Os outros lados do loop (importadas): `ia/skills/code-review/requesting-code-review/` (pedir bem) e `ia/skills/code-review/receiving-code-review/` (incorporar feedback sem defensividade).
