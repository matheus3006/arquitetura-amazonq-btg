...
> processo descrito em `ia/prompts/engenharia/refatorador-incremental.md` — quero comportamento
...
## Referências
- Rede de testes por etapa: `ia/prompts/engenharia/tdd-disciplinado.md` (red-green-refactor).
- Disciplina de conclusão: `engenharia-style.md` § 2 — obrigatória na Fase 3.
- Achou bug no meio? `ia/prompts/engenharia/depurador-sistematico.md`.
- Refatoração de nível arquitetural (fronteiras, módulos): skill `improve-codebase-architecture` (`ia/skills/arquitetura-review/`).
