...
> coberto. Siga todo o processo descrito em `ia/prompts/engenharia/estrategista-de-testes.md` —
...
## Referências
- Escrever cada teste do plano: `ia/prompts/engenharia/tdd-disciplinado.md`.
- Regressão de um bug específico: `ia/prompts/engenharia/depurador-sistematico.md` (a causa raiz vira o teste de regressão).
- Transformar o plano em etapas executáveis: `ia/prompts/engenharia/planejador-de-implementacao.md`.
