...
`ia/prompts/arquitetura/brainstorm-arquitetural.md` (e `gerador-adr.md` para registrar).
...
Preencha o template abaixo e salve em `doc/specs/<AAAA-MM-DD>-<slug>.md`. No chat, só o
...
Um arquivo `doc/specs/<AAAA-MM-DD>-<slug>.md` + resumo no chat. Próximo passo natural:
...
> `ia/prompts/engenharia/especificador.md`: explore o código, me pergunte o que faltar num
...
- Decisão de arquitetura em aberto: `ia/prompts/arquitetura/brainstorm-arquitetural.md` → `gerador-adr.md`.
- Consome a spec: `ia/prompts/engenharia/planejador-de-implementacao.md`.
