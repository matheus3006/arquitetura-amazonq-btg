...
> O plano `doc/planos/2026-06-11-idempotencia-redis.md` foi aprovado. Use
> `ia/prompts/engenharia/executor-de-plano.md`: execute etapa por etapa, verificação por
...
## Referências
- O plano que ele executa: `ia/prompts/engenharia/planejador-de-implementacao.md`.
- Antes de aprovar: `ia/prompts/engenharia/grill-plano.md`.
- Etapas de código test-first: `ia/prompts/engenharia/tdd-disciplinado.md`.
- Quebrou no meio: `ia/prompts/engenharia/depurador-sistematico.md`.
- Turnos, checklist e LEDGER: `ia/prompts/engenharia/controle-de-tarefa.md`.
