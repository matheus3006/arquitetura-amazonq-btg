...
Leia o plano (`doc/planos/…` ou `doc/controle/<task-id>/PLANO.*`), o `project-context.md`
...
- Decisão difícil-de-reverter + surpreendente + trade-off real → ofereça ADR
  (`ia/prompts/arquitetura/gerador-adr.md`). Faltou um dos três? Pule.
...
> O plano `doc/planos/2026-06-11-idempotencia-redis.md` está pronto. Use
> `ia/prompts/engenharia/grill-plano.md`: me interrogue ramo a ramo antes de eu aprovar —
...
- O plano que ele interroga: `ia/prompts/engenharia/planejador-de-implementacao.md`.
- Depois da aprovação: `ia/prompts/engenharia/executor-de-plano.md`.
- Decisão de arquitetura em aberto (não é furo de plano)? `ia/prompts/arquitetura/brainstorm-arquitetural.md`.
- Protocolo de controle (turnos, LEDGER): `ia/prompts/engenharia/controle-de-tarefa.md`.
