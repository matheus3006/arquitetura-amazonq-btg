...
|---|---|---|
| `.kiro/steering/architecture-style.md` (este arquivo) | **REGRA** | Aplique sempre. Convenções de geração e hooks de prompt. |
| `.kiro/steering/frontend-style.md` | **REGRA** | Aplique sempre. Estrutura HTML e padrão de diagramas. |
...
Quando gerar HTML final, **sempre** aplique também `.kiro/steering/frontend-style.md`.
...
- [ ] Apliquei `.kiro/steering/frontend-style.md`?
