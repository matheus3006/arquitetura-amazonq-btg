...
- `skills/arquitetura-review/improve-codebase-architecture/SKILL.md` — reler a arquitetura real do código pra resolver a incerteza.
- `skills/backend/verification-before-completion/SKILL.md` — evidência antes de afirmar; níveis de certeza honestos.
- `skills/documentacao/doc-coauthoring/SKILL.md` — estágio "testar com o leitor": o que o doc NÃO deixa claro pra quem vai usar.
- `skills/arquitetura/human-architect-mindset/SKILL.md` — saber QUAIS incertezas importam (invariantes, falha, ordem temporal, escala).
...
> Sessão nova sobre o `conciliacao-banco`. Siga `prompts/arquitetura/grill-arquitetura.md`
...
## Referências
- Etapas anteriores: `prompts/arquitetura/documentar-servico.md` (1) · `prompts/arquitetura/completar-documentacao.md` (2).
- Revisão geral por lentes (complementar, página a página): `prompts/arquitetura/grill-doc.md`.
