...
- `skills/arquitetura-review/improve-codebase-architecture/SKILL.md` — confirmar cada chamada/estado no código real.
- `skills/documentacao/doc-coauthoring/SKILL.md` — estruturar e testar a doc com o leitor (quem vai usar o runbook às 3h).
- `skills/backend/verification-before-completion/SKILL.md` — nenhum SLO/threshold/fluxo inventado; o que falta vira `[a confirmar]`.
...
`prompts/arquitetura/documentador-fluxo.md`: sequence diagram com `autonumber` (e `BEGIN/COMMIT`
...
Rode TODO o processo de `prompts/arquitetura/gerador-runbook.md`: cada failure mode com
...
> Etapa 1 do `conciliacao-banco` está pronta. Siga `prompts/arquitetura/completar-documentacao.md`
...
## Referências
- Etapa 1: `prompts/arquitetura/documentar-servico.md` · Etapa 3: `prompts/arquitetura/grill-arquitetura.md`.
